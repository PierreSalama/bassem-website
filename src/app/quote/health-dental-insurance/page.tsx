...
const step2Fields = [
  { name: "planType", label: "Plan Type", placeholder: "Individual or Family", type: "text" },
  { name: "coverageLevel", label: "Coverage Level", placeholder: "Basic, Standard, or Premium", type: "text" },
  { name: "existingConditions", label: "Existing Conditions", placeholder: "List any pre-existing conditions (if any)", type: "text" },
...
export default function HealthDentalInsurancePage() {
  ...
  const subject = "New Health & Dental Insurance Quote Submission";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // setFormData({ fullName: "", email: "", phone: "", planType: "", coverageLevel: "", existingConditions: "", startDate: "" });
      } else {
  ...
  return (
    <div className="min-h-screen animate-gradient flex flex-col items-center justify-center p-4 space-y-8 relative">
      ...
      <div className="w-full max-w-md text-center">
        <h1 className="text-5xl font-bold text-white">Health & Dental Insurance</h1>
      </div>
        ...
        {step === 3 && (
          <div>
            ...
            <p className="mb-4 text-gray-800">
              Please review your details before submitting your health & dental insurance request.
            </p>
