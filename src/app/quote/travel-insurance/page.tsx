...
const step2Fields = [
  { name: "destination", label: "Travel Destination", placeholder: "Country, City, or Region", type: "text" },
  { name: "departureDate", label: "Departure Date", placeholder: "", type: "date" },
  { name: "returnDate", label: "Return Date", placeholder: "", type: "date" },
  { name: "travelPurpose", label: "Purpose of Travel", placeholder: "Leisure, Business, etc.", type: "text" },
];
...
export default function TravelInsurancePage() {
  ...
  const subject = "New Travel Insurance Quote Submission";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // setFormData({ fullName: "", email: "", phone: "", destination: "", departureDate: "", returnDate: "", travelPurpose: "" });
      } else {
  ...
  return (
    <div className="min-h-screen animate-gradient flex flex-col items-center justify-center p-4 space-y-8 relative">
      ...
      <div className="w-full max-w-md text-center">
        <h1 className="text-5xl font-bold text-white">Travel Insurance</h1>
      </div>
      ...
      <div className="w-full max-w-md bg-white text-gray-800 rounded-lg shadow-lg p-6">
        ...
        {step === 2 && (
          <div>
            <h2 className="text-lg font-semibold mb-4 text-blue-900">Travel Details</h2>
        ...
        {step === 3 && (
          <div>
            ...
            <p className="mb-4 text-gray-800">
              Please review your details before submitting your travel insurance request.
            </p>
