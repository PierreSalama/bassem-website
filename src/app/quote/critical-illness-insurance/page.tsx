...
const step2Fields = [
  { name: "coverageAmount", label: "Coverage Amount", placeholder: "e.g., $250,000", type: "text" },
  { name: "policyTerm", label: "Policy Term", placeholder: "e.g., 10, 15, or 20 years", type: "text" },
  { name: "existingConditions", label: "Existing Health Conditions", placeholder: "List any pre-existing conditions", type: "text" },
  { name: "startDate", label: "Preferred Start Date", placeholder: "", type: "date" },
];
...
export default function CriticalIllnessInsurancePage() {
  ...
  const subject = "New Critical Illness Insurance Quote Submission";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // setFormData({ fullName: "", email: "", phone: "", coverageAmount: "", policyTerm: "", existingConditions: "", startDate: "" });
      } else {
  ...
  return (
    <div className="min-h-screen animate-gradient flex flex-col items-center justify-center p-4 space-y-8 relative">
      ...
      <div className="w-full max-w-md text-center">
        <h1 className="text-5xl font-bold text-white">Critical Illness Insurance</h1>
      </div>
      ...
      <div className="w-full max-w-md bg-white text-gray-800 rounded-lg shadow-lg p-6">
        ...
        {step === 2 && (
          <div>
            <h2 className="text-lg font-semibold mb-4 text-blue-900">Policy Details</h2>
        ...
        {step === 3 && (
          <div>
            ...
            <p className="mb-4 text-gray-800">
              Please review your details before submitting your critical illness insurance request.
            </p>
