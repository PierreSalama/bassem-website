...
const step2Fields = [
  { name: "companyName", label: "Company Name", placeholder: "e.g., Acme Corp", type: "text" },
  { name: "numEmployees", label: "Number of Employees", placeholder: "e.g., 50", type: "text" },
  { name: "benefitsRequired", label: "Benefits Required", placeholder: "e.g., Health, Dental, Vision", type: "text" },
  { name: "coverageStartDate", label: "Coverage Start Date", placeholder: "", type: "date" },
];

export default function GroupEmployeeBenefitPage() {
  ...
  const subject = "New Group Employee Benefit Quote Submission";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // setFormData({ fullName: "", email: "", phone: "", companyName: "", numEmployees: "", benefitsRequired: "", coverageStartDate: "" });
      } else {
  ...
  return (
    <div className="min-h-screen animate-gradient flex flex-col items-center justify-center p-4 space-y-8 relative">
      ...
      <div className="w-full max-w-md text-center">
        <h1 className="text-5xl font-bold text-white">Group Employee Benefit</h1>
      </div>
      ...
      <div className="w-full max-w-md bg-white text-gray-800 rounded-lg shadow-lg p-6">
        ...
        {/* STEP 2: Group Policy Details */}
        {step === 2 && (
          <div>
            <h2 className="text-lg font-semibold mb-4 text-blue-900">Group Policy Details</h2>
        ...
        {step === 3 && (
          <div>
            ...
            <p className="mb-4 text-gray-800">
              Please review your details before submitting your group employee benefit request.
            </p>
