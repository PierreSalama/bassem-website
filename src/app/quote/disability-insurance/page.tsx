...
export default function DisabilityInsurancePage() {
  ...
  const subject = "New Disability Insurance Quote Submission";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // setFormData({ fullName: "", email: "", phone: "", employmentStatus: "", annualIncome: "", coverageAmount: "", startDate: "" });
      } else {
  ...
  return (
    <div className="min-h-screen animate-gradient flex flex-col items-center justify-center p-4 space-y-8 relative">
      ...
      <div className="w-full max-w-md text-center">
        <h1 className="text-5xl font-bold text-white">Disability Insurance</h1>
      </div>
        ...
        {step === 3 && (
          <div>
            ...
            <p className="mb-4 text-gray-800">
              Please review your details before submitting your disability insurance request.
            </p>
      ...
      <div className="w-full max-w-4xl text-center">
        <h3 className="text-2xl font-bold text-white mb-4">Explore Our Other Insurance Quotes</h3>
